        ...
        return (
          <>
            ...
            >
              ...
              <SideNav aria-label="Side navigation" expanded={isSideNavExpanded} isPersistent={false} isChildOfHeader={true}>
                <SideNavItems>
                  <HeaderSideNavItems>
                    <HeaderMenuItem href="https://www.last.fm/de/user/SpaceUlysses" target="_blank">
                      Last.fm
                  ...
                  <SideNavMenu title="L0 menu 1">
                    <SideNavMenuItem href="javascript:void(0)">L0 menu item 1</SideNavMenuItem>
                    <SideNavMenuItem href="javascript:void(0)">L0 menu item 2</SideNavMenuItem>
                    <SideNavMenuItem href="javascript:void(0)">L0 menu item 3</SideNavMenuItem>
                  </SideNavMenu>
                </SideNavItems>
              </SideNav>
              <HeaderGlobalBar>
...
const EnhancedInformationHeaderGlobalAction = () => {
  ...
  return (
    <>
      ...
      <Modal id="modal1" aria-label="modal1" open={isModalOpen} onRequestClose={closeModal} passiveModal>
